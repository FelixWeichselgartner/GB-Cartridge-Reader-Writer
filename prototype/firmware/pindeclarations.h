...
#define wrPin_high    PORTB |= (1<<PB5);
#define wrPin_low     PORTB &= ~(1<<PB5);
#define mreqPin_high  PORTC |= (1<<PC4);
#define mreqPin_low   PORTC &= ~(1<<PC4);
#define rdPin_high    PORTC |= (1<<PC1);
#define rdPin_low     PORTC &= ~(1<<PC1);
...
#define led_high      PORTC |= (1<<PC3);
#define led_low       PORTC &= ~(1<<PC3);
